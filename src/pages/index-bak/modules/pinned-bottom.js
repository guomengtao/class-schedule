console.log("[pinned-bottom module] loading...")

var pinHelper = require("../../../data/pin-helper.js")

function init(instance) {
  console.log("[pinned-bottom module] init called")
  ...
  instance.loadPinnedPages = function() {
    ...
    pinHelper.getList(function(list) {
      ...
      console.log("[pinned-bottom module] loaded " + list.length + " pinned pages")
    })
  }
  ...
  console.log("[pinned-bottom module] init OK")
}
...
console.log("[pinned-bottom module] loaded successfully")