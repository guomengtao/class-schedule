...
function init(instance) {
  console.log("[clock module] init called")
  ...
  instance.loadPresetCourses = function() {
    ...
    storage.get({
      ...
      success: function(data) {
        ...
        console.log("[clock module] quick-add loaded " + self.quickCourseNames.length + " presets")
      },
      fail: function() {
        self.quickCourseNames = []
      }
  ...
  console.log("[clock module] init OK, clock + quickAdd started")
}
